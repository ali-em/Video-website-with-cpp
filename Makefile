...
$(BUILD)/film.o:$(FILM_CPP) $(ALL_MODELS) $(BUILD)/purchase.o $(BUILD)/comment.o $(TOOLS).h
	$(OC) $(FILM_CPP) -o $(BUILD)/film.o
	
$(BUILD)/comment.o:$(COMMENT_CPP) $(ALL_MODELS) 
	$(OC) $(COMMENT_CPP) -o $(BUILD)/comment.o

$(BUILD)/film_manager.o:$(FILM_MANAGER).h $(FILM_MANAGER).cpp $(TOOLS).h
...
$(BUILD)/comment_handler.o:$(COMMENT_HANDLER).h $(COMMENT_HANDLER).cpp $(BUILD)/tools.o
	$(OC) $(COMMENT_HANDLER).cpp -o $(BUILD)/tools.o

app.out:$(BUILD)/main.o
	$(COMPILE) build/*.o -o app.out
